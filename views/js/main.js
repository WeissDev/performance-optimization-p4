...
var pizzasDiv = document.getElementById("randomPizzas"); // variable moved out of loop for better performance
...
// Credits to Paul Lewis's article @ html5rocks.com/en/tutorials/speed/animations/

// Ensures the latest known scroll position is stored outside the actual function
// so it doesn't have to be calculated on every function call
var latestKnownScrollY = 0,
    ticking = false;

// Decoupled scroll function from main updatePositions function
...
// Calls requestAnimationFrame on updatePositions function
...
function updatePositions() {
  ...
  var items = document.getElementsByClassName('mover'),
      // Moved scrollNum, itemLength and phase out of loop to improve performance
      scrollNum = document.body.scrollTop / 1250,
...
document.addEventListener('DOMContentLoaded', function() {
  var cols = 8,
      s = 256,
      elem; // Moved variable out of loop
  for (var i = 0; i < 100; i++) {
